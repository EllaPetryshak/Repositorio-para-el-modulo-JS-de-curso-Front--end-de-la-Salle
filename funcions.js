console.log("cF%cu%cn%cc%ci%co%cn%cs", "font-weight:bols; color:marron", "font-weight: bold;");
...
console.log(saludoPersona("Ella"));

function writeDni(dni){
  
return dni.slice(4).padStart(9, "X").slice(0,-2).padEnd(9, "X");
}
console.log(writeDni("12345678A"));
